...
import { setBlockchainLoading, setBlockchainTransactionLoading, setBlockchainProvider, setBlockchainIsConnected, setBlockchainContract, setBlockchainAccount, setBlockchainTransactionStatus } from "../actions/blockchain-actions";
interface State {
    loading: boolean,
    account: string;
    provider: any;
...
const blockchainReducer = createReducer(initialState, builder =>
    builder.addCase(setBlockchainLoading, (state, action) => ({ ...state, loading: action.payload}))
